...
<h1 align = "center">🌟LilyGo T-Internet-COM ESP32 Version🌟</h1>

<div align="center">

[English](./README.MD) | [中文](../../../cn/esp32/t-internet-com-esp32/README.MD)

</div>

## Overview

* This page introduces the hardware parameters related to `LilyGo T-Internet-COM ESP32 Version`
...
| 🔗DC Input Voltage    | 5~12V   |

### Button Description

| Button | Function                            |
| ------ | ----------------------------------- |
| BOT    | Customizable function/Download mode |
| RSET   | Reset devices button                |
